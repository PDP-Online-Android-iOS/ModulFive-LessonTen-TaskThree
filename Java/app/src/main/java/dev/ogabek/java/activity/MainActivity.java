...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Feed> getAllFeeds() {
        ...
        feeds.add(new Feed(new Post(R.drawable.ogabekdev, R.drawable.post_2, "ogabekdev", true)));
        ...
        feeds.add(new Feed(new Post(R.drawable.jabbor, R.drawable.post_3, "jabbor", true)));
        feeds.add(new Feed(new Post(R.drawable.jonibek, R.drawable.post_2, "jonibek")));

        feeds.add(new Feed(new Post(R.drawable.ogabekdev, photos, "ogabekdev")));

        feeds.add(new Feed(new Post(R.drawable.shakhriyor, R.drawable.post_1, "shakhriyor", true)));
